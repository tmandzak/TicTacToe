...
public class TicTacToeControl : MonoBehaviour
{
	...
	{
		Rect groupRect = new Rect ((Screen.width / 2) - (titleImage_width / 2), (Screen.height / 2) - ((titleImage_height + button_height) / 2), titleImage.width, titleImage.height + button_height);
